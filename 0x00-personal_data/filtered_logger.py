...
def filter_datum(fields: List[str],
    ...
    """Filters sensitive data from a log line.
    Returns:
        str: The filtered log message with sensitive data replaced.
    """
...
class RedactingFormatter(logging.Formatter):
    """A custom log formatter that redacts sensitive information.
    This formatter extends the logging.
    Args:
    ...
    def format(self, record: logging.LogRecord) -> str:
        """Formats a LogRecord and redacts the specified fields.
        Returns:
